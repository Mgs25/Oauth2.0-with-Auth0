...
namespace SampleMvcApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Profile()
        {
            ...
            string profilePic = User.Claims.FirstOrDefault(c => c.Type == "picture")?.Value;
            string nickname = User.Claims.FirstOrDefault(c => c.Type == "nickname")?.Value;
            string locale = User.Claims.FirstOrDefault(c => c.Type == "locale")?.Value;
            string nameId = User.Claims.FirstOrDefault(c => c.Type == ClaimTypes.NameIdentifier)?.Value;
            bool isGoogle = nameId.Contains("google");
            ...
            {
                cookieValue += (item.Type + ':' + item.Value + ';');
            }

            // Console.WriteLine("COOKIE: " + cookieValue + "\n");

            HttpContext.Response.Cookies.Append("userInfo", cookieValue,
